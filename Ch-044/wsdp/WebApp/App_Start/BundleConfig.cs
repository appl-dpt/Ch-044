...
namespace WebApp
{
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
            ...
            bundles.Add(new ScriptBundle("~/Scripts/GoodPage").Include(
                            "~/Scripts/Good/Good.js"
                            ));
            ...
            bundles.Add(new StyleBundle("~/Content/Grabber").Include(
                "~/Content/Grabber/Grabber.css"));
